				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-6 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Allocation<small>Formulaire d'allocation matériel</small></h2>
								...
								<div class="x_content">
									<br />
									<form method="POST" action="/allocation" class="form-label-left input_mask">
                                        @csrf
										<div class="col-md-6 col-sm-6  form-group has-feedback">
											<input type="text" class="form-control has-feedback-left" name="adresse" id="inputSuccess2" placeholder="Adresse">
											<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
										</div>

										<div class="col-md-6 col-sm-6  form-group has-feedback">
											<input type="text" class="form-control" name="inputSuccess3" id="inputSuccess3" placeholder="ISI" disabled>
                                        ...
                                        <div class="form-group row">
											<label class="col-form-label col-md-3 col-sm-3 ">Utilisateur <span class="required"></span>
											</label>
											<div class="col-md-9 col-sm-9 ">
													
												<select name="user_id" id="heard" class="form-control" required>
                                        ...
                                        <div class="form-group row">
											<label class="col-form-label col-md-3 col-sm-3 ">Matériel <span class="required"></span>
											</label>
											<div class="col-md-9 col-sm-9 ">
													
												<select name="materiel_id" id="heard" class="form-control" required>
													<option value="">Choisir..</option>
                                                @foreach($materiels as $materiel)
                                                    <option value="{{$materiel['id']}}">{{$materiel['marque']}} | {{$materiel['model']}} | {{$materiel['code']}}</option>
                                            ...
                                            <table class="table table-striped jambo_table bulk_action" id="myTable">
                                                ...
                                                @foreach($allocations as $allocation)
                                                    ...
                                                    <tr class="even pointer">
                                                        ...
                                                        <td class=" ">{{$allocation['materiel_id']}}</td>
                                                        <td class=" ">{{$allocation['date']}} </td>
                                                        <td class=" ">{{$allocation['adresse']}} <i class="success fa fa-long-arrow-up"></i></td>
                                                        @foreach($users as $user)
