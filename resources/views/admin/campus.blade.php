				...
				<div class="">
					...
					<div class="row">
						...
						<div class="col-md-6 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Campus <small>Ajouter un campus</small></h2>
							
									<div class="clearfix"></div>
								</div>
								<div class="x_content">
								
									<form method="POST" action="/campu" class="form-label-left input_mask">
                                    @csrf 
										...
										<div class="col-md-6 col-sm-6  form-group has-feedback">
											<input type="text" class="form-control" name="inputSuccess3" id="inputSuccess3" placeholder="Adresse">
...
<div class="input-group">
		<input type="text" id="myInput" onkeyup="myFunction()" class="form-control"  STYLE="color: #000000; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #d4ebff;" placeholder="Nom du campus">
		<span class="input-group-btn">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped jambo_table bulk_action" id="myTable">
                                                ...
                                                <tr class="headings">
                                                    ...
                                                    <th class="column-title">Nom Campus </th>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($campus as $campu)
                                                            ...
                                                            <tr class="even pointer">
                                                                ...
                                                                <td class=" ">{{$campu['libelle']}}</td>
                                                                
														
																<td class=" ">                         
																<!--<a href="#" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Edit </a>-->
																<a href="{{ url('/campus',$campu['id']) }}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Supprimer </a>
																 </td>
                                                            </tr>
                                                     @endforeach 
													 @endif
