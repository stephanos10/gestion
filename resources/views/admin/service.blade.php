				...
				<div class="">
					...
					<div class="row">
						...
						<div class="col-md-6 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Service <small>Ajouter un service</small></h2>
							
									<div class="clearfix"></div>
								</div>
								<div class="x_content">
								
									<form method="POST" action="/service" class="form-label-left input_mask">
                                    @csrf 
...
<div class="input-group">
		<input type="text" id="myInput" onkeyup="myFunction()" class="form-control"  STYLE="color: #000000; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #d4ebff;" placeholder="Nom du service">
		<span class="input-group-btn">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped jambo_table bulk_action" id="myTable">
                                                ...
                                                <tr class="headings">
                                                    ...
                                                    <th class="column-title">Nom Service </th>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($services as $service)
                                                            ...
                                                            <tr class="even pointer">
                                                                ...
                                                                <td class=" ">{{$service['libelle']}}</td>
                                                                
														
																<td class=" ">                         
																<!--<a href="#" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Edit </a>-->
																<a href="{{ url('/services',$service['id']) }}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Supprimer </a>
																 </td>
                                                            </tr>
                                                     @endforeach 
													 @endif
