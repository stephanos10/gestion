				...
				<div class="">
					...
					<div class="row">
                        ...
                        <div class="col-md-6 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Matériels <small>Signalés</small></h2>
							
									<div class="clearfix"></div>
                                    <a href="/approsaveall" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> Enregistrer </a>
									<a href="#" class="btn btn-info btn-xs" ><i class="fa fa-pencil"></i> Nouvelle </a>
                                            ...
                                            <tbody>
                                                    ...
                                                    @foreach($signalers as $signaler)
                                                        @foreach($materiels as $materiel)
                                                            @if($signaler['materiel_id'] == $materiel['id'])
                                                            <tr class="even pointer">
                                                                ...
                                                                <td class=" last"><a href="#">{{$signaler['message']}}</a>
                                                                <td class=" "> 
                                                                @if($materiel['etat'] == "nickel")                 
                                                                    <a href="#" class="btn btn-info btn-xs" data-target="#MySecondmodal"  data-toggle="modal"><i class="fa fa-pencil" ></i> Valider </a>
                                                                @endif
                                                                    <a href="/signal/{{$signaler['id']}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                                                                </td>
                                                            </tr>
                                                 ...
                                                 <div class="modal fade" id="MySecondmodal">
                                                    ...
                                                    <form method="POST" action="/signale" enctype="multipart/form-data" class="form-label-left input_mask">
                                                          @csrf
                                                                                                     
                            

                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-md-3 col-sm-3 ">Décision sur matériel <span class="required"></span>
                                                                        </label>
                                                                        <div class="col-md-9 col-sm-9 ">
                                                                                                                        
                                                                            <select name="etat" id="heard" class="form-control" required>
                                                                            <option value="no">Choisir..</option>
                                                        ...
                                                        <input type="hidden"  name="idmat" value="{{$signaler['materiel_id']}}"/>
