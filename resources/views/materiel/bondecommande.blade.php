				...
				<div class="">
					...
					<div class="row">
                        ...
                        <div class="col-md-6 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Nouveau <strong>Bon</strong></h2>
							
									<div class="clearfix"></div>
                                    <a href="/bdsaveall/{{session('userID')}}" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> Enregistrer </a>
									<a href="#" class="btn btn-info btn-xs" data-target="#MySecondmodal" data-toggle="modal"><i class="fa fa-pencil"></i> Nouvelle </a>
																				...
																				<div class="modal-content">
																					<div class="modal-header">
																						...
																						<h4 class="modal-title">Produit</h4>                                                             
                                                                                            ...
                                                                                            <form method="POST" action="/bondecom" enctype="multipart/form-data" class="form-label-left input_mask">
                                                                                        @csrf
                                                                                       
                                                                                        <div class="col-md-6 col-sm-6  form-group has-feedback">
                                                                                            <input type="text" class="form-control has-feedback-left" name="nfour" id="inputSuccess2" placeholder="Nom fournisseur">
                                                                                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                                                                        </div>
                                                                                        <div class="col-md-6 col-sm-6  form-group has-feedback">
                                                                                            <input type="text" class="form-control has-feedback-left" name="numfour" id="inputSuccess2" placeholder="Numéro">
                                                                                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                                                                        </div>
                                                                                        <div class="col-md-6 col-sm-6  form-group has-feedback">
                                                                                            <input type="text" class="form-control has-feedback-left" name="designation" id="inputSuccess2" placeholder="Désignation">
                                                                                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                                                                        </div>

                                                                                        <div class="col-md-6 col-sm-6  form-group has-feedback">
                                                                                            <input type="number" class="form-control" name="nombre" id="inputSuccess3" placeholder="Nombre">
                                                                                        ...
                                                                                        <div class="col-md-6 col-sm-6  form-group has-feedback">
                                                                                            <input type="number" class="form-control" name="prix" id="inputSuccess5" placeholder="Prix">
                                                                                            <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group row">
                                                                                            <label class="col-form-label col-md-3 col-sm-3 ">Date <span class="required">*</span>
                                                                                            </label>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($mats as $appro)
                                                    ...
                                                    <tr class="even pointer">
                                                        ...
                                                        <td class=" ">{{$appro['nombre']}} </td>
                                                        <td class=" ">{{$appro['prix']}} <i class="success fa fa-long-arrow-up"></i></td>
                                                        <td class=" ">{{$appro['nfournisseur']}} </td>
                                                      
                            
                                                        <td class=" ">                         
                                                            <a href="#" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                                            <a href="/bdcomde/{{$appro['id']}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                                                        </td>
                                                    </tr>
                                                    @endforeach 
                                                    @endif
