				...
				<div class="">
					...
					<div class="row">
                        ...
                        <div class="col-md-6 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Nouvelle ligne <small>Approvisionnement</small></h2>
																				...
																				<div class="modal-content">
																					<div class="modal-header">
																						...
																						<h4 class="modal-title">Produit</h4>                                                             
                                                                                            ...
                                                                                            <form method="POST" action="/approvisionnement" enctype="multipart/form-data" class="form-label-left input_mask">
                                                                                        @csrf
																						...
																						<div class="col-md-6 col-sm-6  form-group has-feedback">
                                                                                            <input type="text" class="form-control has-feedback-left" name="nomf" id="inputSuccess2" placeholder="nom du fournisseur">
                                                                                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                                                                        </div>
																						<div class="col-md-6 col-sm-6  form-group has-feedback">
                                                                                            <input type="text" class="form-control has-feedback-left" name="contactf" id="inputSuccess2" placeholder="son contact">
                                                                                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                                                                        </div>
																						<div class="col-md-6 col-sm-6  form-group has-feedback">
                                                                                            <input type="text" class="form-control has-feedback-left" name="adressef" id="inputSuccess2" placeholder="son adresse">
                                                                                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                                                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($appros as $appro)
                                                    ...
                                                    <tr class="even pointer">
                                                        ...
                                                        <td class=" ">{{$appro['ident']}} <i class="success fa fa-long-arrow-up"></i></td>
                                                        ...
                                                        <td class=" ">                         
                                                            ...
                                                            <a href="/approvisionnement/{{$appro['id']}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                                                        </td>
                                                    </tr>
                                                    @endforeach 
                                                    @endif
