                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped jambo_table bulk_action" id="myTable">
                                                ...
                                                @if(isset($mats))
                                                    @foreach($mats as $materiel)

                                                        <tr class="even pointer">
                                                            <td class="a-center ">
                                                            <input type="checkbox" class="flat" name="table_records">
                                                            </td>
                                                            <td class=" ">ISI_0B{{$materiel['id']}}</td>
                                                            <td class=" ">{{$materiel['date']}} </td>
                                                          
                                 
															<td class=" ">                         
																<a href="/bdcomvue/{{$materiel['id']}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Afficher </a>
