				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-6 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>DEMANDES<small>Formulaire de décision sur une demande</small></h2>
								...
								<div class="x_content">
									<br />
									<form method="POST" action="/demandeModif" class="form-label-left input_mask">
                                        @csrf
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												...
												<textarea id="message" required="required" placeholder="{{$demand}}" class="form-control" name="libelle" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.." data-parsley-validation-threshold="10"></textarea>
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												...
												<select name="type_id" id="heard" class="form-control" required>
													<option value="">{{$typedemand}}</option>
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
                                                ...
                                                <label for="message">Reponse (20 chars min, 100 max) :</label>
												<textarea id="message" required="required"  class="form-control" name="reponse" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.." data-parsley-validation-threshold="10"></textarea>
                                        ...
                                        <div class="form-group row">
											<label class="col-form-label col-md-3 col-sm-3 ">Validation <span class="required"></span>
											</label>
											<div class="col-md-9 col-sm-9 ">
													
												<select name="valid" id="heard" class="form-control" required>
										...
										<div class="form-group row">
											<div class="col-md-9 col-sm-9  offset-md-3">
												<button type="submit" class="btn btn-success">Eneregistrer</button>
											</div>
										</div>
