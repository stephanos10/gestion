				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>Table des Approvisionnements</h3>
						</div>

						<div class="title_right">
							<div class="col-md-5 col-sm-5  form-group pull-right top_search">
								<div class="input-group">
									<input type="text" id="myInput" onkeyup="myFunction()"  class="form-control" placeholder="code approvisionnement">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($appros as $appro)
                                                        ...
                                                        <tr class="even pointer">
                                                            ...
                                                            <td class=" ">Appro{{$appro['id']}}</td>
															<td class=" ">Approvisionement_du_{{$appro['date']}}</td>

                                 
															<td class=" ">                         
																<a href="/approvisionnementvue/{{$appro['id']}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Afficher </a>
